  ...
  experiences: Experience[] = [
    {
      ...
      responsibilities: [
        "Lead security remediation across distributed Java Spring Boot and Node.js microservices for a Fortune 25 healthcare client, addressing 40+ vulnerabilities per day through dependency upgrades, EOL migrations, and configuration hardening",
        "Evaluate vulnerability impact across distributed microservices, leading cross-functional remediation sprints and enforcing rigorous regression testing to preserve production reliability and uptime",
      ],
      bgColor: "bg-teal-600",
